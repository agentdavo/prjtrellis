...
jobs = [
    ("MULT9_R{}C{}".format(r, c0),     "MULT9_0", FuzzConfig(job="MULT9_0", family="ECP5", device=DEVICE, ncl="empty.ncl",
                                                              tiles=dsp_tiles)),
    ("MULT9_R{}C{}".format(r, c0 + 1), "MULT9_1", FuzzConfig(job="MULT9_1", family="ECP5", device=DEVICE, ncl="empty.ncl",
                                                              tiles=dsp_tiles)),
    ("MULT9_R{}C{}".format(r, c0 + 4), "MULT9_4", FuzzConfig(job="MULT9_4", family="ECP5", device=DEVICE, ncl="empty.ncl",
                                                              tiles=dsp_tiles)),
    ("MULT9_R{}C{}".format(r, c0 + 5), "MULT9_5", FuzzConfig(job="MULT9_5", family="ECP5", device=DEVICE, ncl="empty.ncl",
                                                              tiles=dsp_tiles)),
]
