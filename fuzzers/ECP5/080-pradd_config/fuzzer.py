...
if DEVICE == "LFE5U-25F":
    loc9, loc18 = "PRADD9_R13C4", "PRADD18_R13C4"
elif DEVICE == "LFE5UM5G-85F":
    loc9, loc18 = "PRADD9_R34C58", "PRADD18_R34C58"
else:
    raise RuntimeError("Unsupported TRELLIS_DEVICE '{}' for this fuzzer".format(DEVICE))

jobs = [
    (loc9, "PRADD9_0", "PRADD9", "PRADD9A", FuzzConfig(job="PRADD9_0", family="ECP5", device=DEVICE, ncl="empty.ncl", tiles=dsp_tiles)),
    (loc18, "PRADD18_0", "PRADD18", "PRADD18A", FuzzConfig(job="PRADD18_0", family="ECP5", device=DEVICE, ncl="empty.ncl", tiles=dsp_tiles)),
]
